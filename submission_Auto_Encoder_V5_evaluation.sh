...
#BSUB -q gpu
#BSUB -W 48:00
#BSUB -o out/AutoEncoder_V5_evaluation.%J
#BSUB -n 24
#BSUB -R "ngpus=2"
...
$HOME/build/Python-3.6.7/python $HOME/Auto_Encoder_V5_evaluation.py &> output/output_Auto_Encoder_V5_evaluation_Run_1&
wait
