...
Y_name = '/home/cloud/Create_Data/' + "out/" + "Y_rad41.npy"
Y = np.load(Y_name) 
...
Y_name = '/home/cloud/Create_Data/' + "out/" + "Y_train_rad41.npy"
np.save(Y_name, Y_train) 
del(Y_train)
gc.collect()

Y_test = Y[pics_test, :, :,:]
Y_name = '/home/cloud/Create_Data/' + "out/" + "Y_test_rad41.npy"
np.save(Y_name, Y_test) 
del(Y_test)
gc.collect()

Y_validate = Y[pics_validate, :, :,:]
Y_name = '/home/cloud/Create_Data/' + "out/" + "Y_validate_rad41.npy"
...
X_name = '/home/cloud/Create_Data/' + "out/" + "X_rad41.npy"
X = np.load(X_name) 

X_train = X[pics_train, :, :,:]
X_name = '/home/cloud/Create_Data/' + "out/" + "X_train_rad41.npy"
np.save(X_name, X_train) 
del(X_train)
gc.collect()

X_test = X[pics_test, :, :,:]
X_name = '/home/cloud/Create_Data/' + "out/" + "X_test_rad41.npy"
np.save(X_name, X_test) 
del(X_test)
gc.collect()
X_validate = X[pics_validate, :, :,:]
X_name = '/home/cloud/Create_Data/' + "out/" + "X_validate_rad41.npy"
