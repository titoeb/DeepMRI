...
Y_name = '/home/cloud/Create_Data/' + "out/" + "Y_train_pois_1_9.npy"
np.save(Y_name, Y_train) 
del(Y_train)
gc.collect()

Y_test = Y[pics_test, :, :,:]
Y_name = '/home/cloud/Create_Data/' + "out/" + "Y_test_pois_1_9.npy"
np.save(Y_name, Y_test) 
del(Y_test)
gc.collect()

Y_validate = Y[pics_validate, :, :,:]
Y_name = '/home/cloud/Create_Data/' + "out/" + "Y_validate_pois_1_9.npy"
...
X_name = '/home/cloud/Create_Data/' + "out/" + "X_train_pois_1_9.npy"
np.save(X_name, X_train) 
del(X_train)
gc.collect()

X_test = X[pics_test, :, :,:]
X_name = '/home/cloud/Create_Data/' + "out/" + "X_test_pois_1_9.npy"
np.save(X_name, X_test) 
del(X_test)
gc.collect()

X_validate = X[pics_validate, :, :,:]
X_name = '/home/cloud/Create_Data/' + "out/" + "X_validate_pois_1_9.npy"
