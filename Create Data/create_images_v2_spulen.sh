...
{	
	...
	{	
		...
		slice_output="./Images_Y/P"$p_num"_u_slicex"$ix

		# Output for k-space
		slice_input_rss="./Images_X/P"$p_num"_slicex"$ix
		slice_output_und_rss="./Images_Y/P"$p_num"_u_slicex"$ix
		...
		bart rss $(bart bitmask 3) tmp1 $slice_input_rss
	...
	{	
		...
		slice_output_png="./Images_Y/P"$p_num"_reco_slicez"$iz".png"
